...
-----------------------------------------------------------------------------------------------------------
-- ERROR Primary kay no puede ser null
...
-----------------------------------------------------------------------------------------------------------
-- ERROR Rut tiene que ser unico
INSERT INTO Empleados (EmpleadoID, Nombre, Apellido, Rut) VALUES (11, 'Livio', null, '90123456-7');
ERROR:  llave duplicada viola restricción de unicidad «empleados_rut_key»
DETAIL:  Ya existe la llave (rut)=(90123456-7).

-----------------------------------------------------------------------------------------------------------
INSERT INTO Empleados (EmpleadoID, Nombre, Apellido, Rut) VALUES (11, 'Livio', null, '87654321-9');
