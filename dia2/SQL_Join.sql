...
/*SELECT *
FROM TABLAA A --SE RECOMIENDO AGREGAR COMO TABLA A AQUELLA QUE TENGA LA PK (EL "A" ES UN ALIAS)
INNER JOIN TABLAB B
ON A.KEY = B.KEY;*/
...
SELECT *
FROM productos A      -- SE RECOMIENDA AGREGAR COMO TABLAA AQUELLA TABLA QUE TENGA LA PK
